    ...
    <Layout>
        <Layout.Content>
            ...
            <Typography.Paragraph>
                I'm Ruairi Dorrity, a full-stack software engineer based in San Francisco. I studied Computer Science at the University of Cambridge before moving to the US. Right now, I do full-stack things at <ExternalLink href="https://airtable.com/about">Airtable</ExternalLink>. Outside of work, I spend most of my time tinkering with side projects, making music, playing Scrabble, and watching, playing or talking about <Tooltip title="⚽, not 🏈">football</Tooltip>.
            </Typography.Paragraph>
            <Typography.Paragraph>
